...
const Hero = () => {
  const socialLinks = [
    {
      icon: Twitter,
      href: "https://twitter.com/poojitha91645",
      label: "Twitter",
    },
    {
      icon: Instagram,
      href: "https://instagram.com/pagidimarripoojachary",
      label: "Instagram",
    },
    {
      icon: Github,
      href: "https://github.com/pagidimarri-poojitha-chary/",
      label: "GitHub",
    },
    {
      icon: Linkedin,
    ...
    >
      ...
      >
        <motion.a
          ...
          whileHover={{ y: -5 }}
        >
          pagidimarripoojitha97@gmail.com
        </motion.a>
      </motion.div>
