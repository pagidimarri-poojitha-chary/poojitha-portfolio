...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "pagidimarripoojitha97@gmail.com",
      href: "mailto:pagidimarripoojitha97@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 8125883729",
      href: "tel:+918125883729"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/pagidimarri-poojitha-chary/', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/poojitha-pagidimarri-6637a9341/ha/', label: 'LinkedIn' },
    { icon: Twitter, href: 'https://twitter.com/@poojitha91645', label: 'Twitter' },
    { icon: Instagram, href: 'https://instagram.com/pagidimarripoojachary', label: 'Instagram' },
  ];
